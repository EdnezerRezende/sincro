...
7. **Selo compacto do `trailing`** ("Ativar / Biofeedback", "Conectar / Gmail"): largura máxima 112 dp × escala de texto (a palavra mais longa, "Biofeedback", mede ≈ 87 dp em 14/700), padding 8/6, mínimo 44 dp de altura; nunca quebra a própria palavra — o teste trava em ≤ 2 linhas em 1,0× e 1,3×.
