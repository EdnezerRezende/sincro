...
export function triagem(
  ...
  if (brando)
    return {
      ...
      nivel: 'nao',
      sinais: [],
      motivo: `veto brando: ${brando.source}`,
    };
  ...
  if (brandoTardio)
    return {
      ...
      nivel: 'nao',
      sinais: [],
      motivo: `veto brando: ${brandoTardio.source}`,
    };
  if (DESCONTO_TARDIO_RE.test(aLower) && !CICLO_RE.test(aLower)) {
    return {
      ...
      nivel: 'nao',
      sinais: [],
      motivo: `veto brando: ${DESCONTO_TARDIO_RE.source}`,
    };
  }
