 ...
 *  sem depender de qual lado o `\b` original ocupava no padrão. `wb()` substitui todo `\b` por
 *  `WB` — a paridade de ocorrência (esquerda vs. direita) é irrelevante e não deve ser usada para
 *  decidir o lado. */
export const WB =
